// first_challenge_igarashi.hppをインクルード
#include "first_challenge_igarashi/first_challenge_igarashi.hpp"// ここに書く

FirstChallenge::FirstChallenge() : Node("first_challenge_igarashi")
{
    // global変数を定義
